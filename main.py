...
def main():
    ...
    prompt_for_images='For scene [scene] write an image prompt. The goal is to generate visuals for this scene using this prompt. Do not explain what you are doing, just write the prompt.'
